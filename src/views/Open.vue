...
export default {
    ...
    beforeCreate(){
        ...
        xhr.open('POST','http://haitang.twt.edu.cn/api/v1/auth/client?token='+token);
        xhr.send(null);
        ...
        // var xhr = new XMLHttpRequest();
        // xhr.open('POST','http://haitang.twt.edu.cn/api/v1/auth/wechat?password=LHX&userNumber=3021');
        // xhr.send(null);
        // xhr.onload = function(e){
        //     var json = JSON.parse(e.target.response)
        //     that.$store.commit('setToken', json.result)
